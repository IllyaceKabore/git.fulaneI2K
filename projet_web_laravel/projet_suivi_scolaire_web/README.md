# 📱 Application Mobile de Suivi Scolaire Parent-Enfant
...
1. **Cloner le dépôt**
```bash
git clone https://github.com/IllyaceKabore/projet-suivi-scolaire.git
...
5. **Se connecter**
   - Utiliser un des [comptes de test](#-comptes-de-test) ci-dessous pour se connecter en tant que parent.
